...
#define INPUTLOCATION1 "D:/ICT/CodeBlocks/projects/AoC2020/inputData/day1.txt"       //CHANGE THIS TO YOUR OWN LOCATION IF YOU USE IT!
...
void day1a() {
    openInputFile(INPUTLOCATION1);          //open inputfile with data
    uint8_t found = 0;
    uint16_t numA;
    uint16_t numB;
